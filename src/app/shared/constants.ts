...
export const nnNetwork = {
    oauthLoginUrl: 'https://wwww-stage.newbienudes.com/user/auth',
    oauthTokenUrl: 'https://api-stage.newbienudes.com/api/auth/token',
    oauthCallbackUrl: 'https://www-stage.newbienudes.com/oauth/callback',
    clientId: 'WKMNKdARjpSbGB3KGpXeC4wZ8',
    oauthUser: 'https://api-stage.newbienudes.com/api/user'
};
